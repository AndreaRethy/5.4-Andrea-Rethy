...
3. Escriu una consulta per mostrar restaurant_id, name, borough i zip code, però excloent el camp _id per tots els documents en la col·lecció Restaurants.
4. Escriu una consulta per mostrar tots els restaurants que estan en el Bronx.
5. Escriu una consulta per mostrar els primers 5 restaurants que estan en el Bronx.
6. Escriu una consulta per mostrar els 5 restaurants després de saltar els primers 5 que siguin del Bronx.
7. Escriu una consulta per trobar els restaurants que tenen algun score més gran de 90.
8. Escriu una consulta per trobar els restaurants que tenen un score més gran que 80 però menys que 100.
9. Escriu una consulta per trobar els restaurants que estan situats en una longitud inferior a -95.754168.
10. Escriu una consulta de MongoDB per a trobar els restaurants que no cuinen menjar 'American ' i tenen algun score superior a 70 i longitud inferior a -65.754168.
